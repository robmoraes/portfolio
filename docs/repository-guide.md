# Guia Tecnico do Repositorio

Este documento concentra os detalhes tecnicos do portfolio para manter o
`README.md` focado na apresentacao executiva do projeto.
