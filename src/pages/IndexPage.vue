...
import portfolioQrCode from '@/assets/portfolio-qr.png'
...
// PDF Certificates
import cert01 from '@/assets/certificates/01-analista-e-projetista-oo.pdf'
import cert02 from '@/assets/certificates/02-extreme-programming.pdf'
import cert03 from '@/assets/certificates/03-formacao-windows-2003.pdf'
import cert04 from '@/assets/certificates/04-iso-auditor-interno.pdf'
import cert05 from '@/assets/certificates/05-iso-gestao-da-qualidade.pdf'
import cert06 from '@/assets/certificates/06-linux-conceitos-install-e-admin.pdf'
import cert07 from '@/assets/certificates/07-linux-servicos-de-internet.pdf'
import cert08 from '@/assets/certificates/08-oracle-data-modeling.pdf'
import cert09 from '@/assets/certificates/09-oracle-database-10g.pdf'
import cert10 from '@/assets/certificates/10-php-code-igniter-2.pdf'
import cert11 from '@/assets/certificates/11-php-orientado-a-objetos.pdf'
import cert12 from '@/assets/certificates/12-postgresql-pgcon-2008.pdf'
import cert13 from '@/assets/certificates/13-scrum-projetos-ageis.pdf'
import cert14 from '@/assets/certificates/14-aprenda-go-do-zero.pdf'
import cert15 from '@/assets/certificates/15-devops-docker-kubernetes-e-rancher.pdf'
import cert16 from '@/assets/certificates/16-go-explorando-a-lang.pdf'
